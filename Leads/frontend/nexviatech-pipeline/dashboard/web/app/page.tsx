...
import { ArrowRight, Globe, Zap, Layout as LayoutIcon, MessageCircle } from 'lucide-react';
      ...
      <section className="relative px-6 py-24 md:py-32 lg:py-48 flex flex-col items-center text-center overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link href="/india/indore/dentist/quality-dental-care" className="px-6 py-3 bg-[#00e5d4] text-[#0a0f1e] font-display font-bold text-sm rounded-lg hover:bg-white transition-colors flex items-center justify-center gap-2">
              Dentist Demo <ArrowRight size={16} />
            </Link>
            <Link href="/usa/new-york/restaurant/joes-pizza" className="px-6 py-3 bg-[#00e5d4] text-[#0a0f1e] font-display font-bold text-sm rounded-lg hover:bg-white transition-colors flex items-center justify-center gap-2">
