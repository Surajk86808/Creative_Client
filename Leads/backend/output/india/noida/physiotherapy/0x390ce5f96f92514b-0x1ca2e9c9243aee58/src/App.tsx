      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl leading-[1.1] text-primary mb-8">
            Neuro Spine Physiotherapy Dr. Pramod mp...: Precision Care for Your <br/>
            <span className="italic font-serif">Dental Health</span>
          </h1>
          <p className="text-lg md:text-xl text-primary/70 max-w-lg mb-10 leading-relaxed">Trusted physiotherapy in Noida</p>
        ...
        >
          <div className="rounded-[40px] overflow-hidden shadow-2xl relative aspect-[4/5]">
            <img 
              src="https://source.unsplash.com/2000x1200/?physiotherapy,business" 
            ...
            >
              <div className="flex -space-x-3 mb-3">
                {["https://source.unsplash.com/200x200/?portrait,person", "https://source.unsplash.com/200x200/?portrait,smile", "https://source.unsplash.com/200x200/?portrait,professional"].map((src) => (
                  <img
                    key={src}
                    src={src}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div className="relative">
          <div className="rounded-[40px] overflow-hidden shadow-2xl">
            <img 
              src="https://source.unsplash.com/1200x900/?physiotherapy,interior" 
              alt="Expert Doctor" 
        ...
        <div>
          ...
          <p className="text-lg text-primary/70 mb-10 leading-relaxed">Neuro Spine Physiotherapy Dr. Pramod mpt Neur... provides professional physiotherapy services for customers in Arti Hospital & Trama Center, Plot No. 11-12, Parthala Khanjarpur, Sector 122.... We focus on quality, clear communication, and great results. Call 087448 35509 to get started.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input className="bg-background border-none rounded-2xl p-4 focus:ring-2 focus:ring-secondary outline-none" placeholder="care@drpramodneuro.com" type="email" />
              </div>
            </div>
            <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-8">
          <div className="rounded-[32px] overflow-hidden h-[300px] shadow-lg relative group">
            <img 
              src="https://source.unsplash.com/1200x900/?team,work" 
              alt="Map Location" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: <Phone size={20} />, label: "Phone", value: "087448 35509" },
              { icon: <Mail size={20} />, label: "Email", value: "care@drpramodneuro.com" },
              { icon: <MapPin size={20} />, label: "Studio", value: "Arti Hospital & Trama Center, Plot No. 11-12, Parthala Khanjarpur, Sector 122, Noida, Uttar Pradesh 201301" },
            ].map((item, i) => (
  ...
  return (
    <footer className="bg-primary pt-20 pb-10 w-full text-white">
      ...
      <div className="mt-20 border-t border-white/5 pt-10 px-6 flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto">
        <p className="text-xs text-white/40">© 2024 Neuro Spine Physiotherapy Dr. Pramod mp.... Precision in Healing.</p>
