      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl leading-[1.1] text-primary mb-8">
            Onyx physiocare: Precision Care for Your <br/>
    ...
    <section id="the-studio" className="py-24 px-6 md:px-12 bg-surface">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-primary/70 mb-10 leading-relaxed">Onyx physiocare provides professional physiotherapy services for customers in Purvanchal Royal Park, Tower 8, 802, Sector 137, Noida, Uttar Pradesh 201304. We focus on quality, clear communication, and great results. Call 096549 71259 to get started.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: <Phone size={20} />, label: "Phone", value: "096549 71259" },
              { icon: <Mail size={20} />, label: "Email", value: "" },
              { icon: <MapPin size={20} />, label: "Studio", value: "Purvanchal Royal Park, Tower 8, 802, Sector 137, Noida, Uttar Pradesh 201304" },
            ].map((item, i) => (
  ...
  return (
    <footer className="bg-primary pt-20 pb-10 w-full text-white">
      ...
      <div className="mt-20 border-t border-white/5 pt-10 px-6 flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto">
        <p className="text-xs text-white/40">© 2024 Onyx physiocare. Precision in Healing.</p>
