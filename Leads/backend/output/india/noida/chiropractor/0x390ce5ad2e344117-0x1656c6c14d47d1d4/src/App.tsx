    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'glass-nav shadow-lg py-3' : 'bg-transparent py-5'}`}>
      <nav className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className={`text-2xl font-black tracking-tighter uppercase ${isScrolled ? 'text-primary' : 'text-white'}`}>
          Best Chiropractor and Sports Physiother...
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          ...
          <p className="text-on-surface-variant max-w-2xl text-lg leading-relaxed">
            Engineering-grade solutions for your home and business. Every technician is certified to Best Chiropractor and Sports Physiother... standards.
          </p>
        </div>
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div>
          <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 tracking-tight">Best Chiropractor and Sports Physiother...: Your Next Project</h2>
          <p className="text-on-surface-variant mb-12 text-lg">Best Chiropractor and Sports Physiotherapy Cl... provides professional chiropractor services for customers in D-139, Block D, Sector 40, Noida, Uttar Pradesh 201303. We focus on quality, clear communication, and great results. Contact us to get started.</p>
            ...
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
              ...
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  D-139, Block D, Sector 40, Noida, Uttar Pradesh 201303
                </p>
              </div>
            </div>
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
    ...
    <footer className="bg-primary text-white pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
        <div className="col-span-1 lg:col-span-1">
          <span className="text-3xl font-black text-white mb-8 block uppercase tracking-tighter">Best Chiropractor and Sports Physiother...</span>
