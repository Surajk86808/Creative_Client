    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'glass-nav shadow-lg py-3' : 'bg-transparent py-5'}`}>
      <nav className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className={`text-2xl font-black tracking-tighter uppercase ${isScrolled ? 'text-primary' : 'text-white'}`}>
          NeuroTrack Advance Neuro Rehabilitation...
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          ...
          <p className="text-on-surface-variant max-w-2xl text-lg leading-relaxed">
            Engineering-grade solutions for your home and business. Every technician is certified to NeuroTrack Advance Neuro Rehabilitation... standards.
          </p>
        </div>
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div>
          <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 tracking-tight">NeuroTrack Advance Neuro Rehabilitation...: Your Next Project</h2>
          <p className="text-on-surface-variant mb-12 text-lg">NeuroTrack Advance Neuro Rehabilitation Centre provides professional chiropractor services for customers in H9GW+62M, Sector 117, Noida, Uttar Pradesh 201301. We focus on quality, clear communication, and great results. Call 0120 524 4855 to get started.</p>
            ...
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
              ...
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  H9GW+62M, Sector 117, Noida, Uttar Pradesh 201301
                </p>
              </div>
            </div>
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
              ...
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  0120 524 4855 · 24/7 Availability
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-primary text-white pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
        <div className="col-span-1 lg:col-span-1">
          <span className="text-3xl font-black text-white mb-8 block uppercase tracking-tighter">NeuroTrack Advance Neuro Rehabilitation...</span>
