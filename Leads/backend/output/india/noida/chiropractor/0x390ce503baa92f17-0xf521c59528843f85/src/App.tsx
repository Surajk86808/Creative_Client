      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          ...
          <p className="text-on-surface-variant max-w-2xl text-lg leading-relaxed">
            Engineering-grade solutions for your home and business. Every technician is certified to Dr.Kashish Chaudhary standards.
          </p>
        </div>
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div>
          <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 tracking-tight">Dr.Kashish Chaudhary: Your Next Project</h2>
          <p className="text-on-surface-variant mb-12 text-lg">Dr.Kashish Chaudhary(JYRAJ Physiotherapy Clinic) provides professional chiropractor services for customers in Paramount Floraville, Shop No.13, Ground Floor, Tower Florence Plaza, Sector.... We focus on quality, clear communication, and great results. Call 088649 62878 to get started.</p>
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <input 
                className="w-full bg-surface-container-low border-none rounded-xl p-5 focus:ring-2 focus:ring-secondary-container transition-all outline-none" 
                placeholder="info@jyrajclinic.com" 
                type="email"
              />
            </div>
            ...
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
              ...
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  Paramount Floraville, Shop No.13, Ground Floor, Tower Florence Plaza, Sector 137, Noida, Uttar Pradesh 201304
                </p>
              </div>
            </div>
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
              ...
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  088649 62878 · 24/7 Availability
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-primary text-white pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
        <div className="col-span-1 lg:col-span-1">
          <span className="text-3xl font-black text-white mb-8 block uppercase tracking-tighter">Dr.Kashish Chaudhary</span>
