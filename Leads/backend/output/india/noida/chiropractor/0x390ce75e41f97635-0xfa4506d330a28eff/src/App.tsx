      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          ...
          <p className="text-on-surface-variant max-w-2xl text-lg leading-relaxed">
            Engineering-grade solutions for your home and business. Every technician is certified to Dr Jain's Physiotherapy standards.
          </p>
        </div>
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div>
          <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 tracking-tight">Dr Jain's Physiotherapy: Your Next Project</h2>
          <p className="text-on-surface-variant mb-12 text-lg">Dr Jain's Physiotherapy provides professional chiropractor services for customers in CM 60 A sector 144, opposite RWA office, Sector 144, Noida, Uttar.... We focus on quality, clear communication, and great results. Call 075248 54400 to get started.</p>
            ...
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
              ...
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  CM 60 A sector 144, opposite RWA office, Sector 144, Noida, Uttar Pradesh 201306
                </p>
              </div>
            </div>
            <div className="flex items-start gap-6 p-8 bg-surface-container-low rounded-2xl">
              ...
              <div>
                ...
                <p className="text-on-surface-variant leading-relaxed">
                  075248 54400 · 24/7 Availability
                </p>
              </div>
            </div>
          </div>
    ...
    <footer className="bg-primary text-white pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
        <div className="col-span-1 lg:col-span-1">
          <span className="text-3xl font-black text-white mb-8 block uppercase tracking-tighter">Dr Jain's Physiotherapy</span>
