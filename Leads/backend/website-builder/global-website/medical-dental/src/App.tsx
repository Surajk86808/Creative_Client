      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl leading-[1.1] text-primary mb-8">
            [[SHOP_NAME]]: Precision Care for Your <br/>
            <span className="italic font-serif">Dental Health</span>
          </h1>
          <p className="text-lg md:text-xl text-primary/70 max-w-lg mb-10 leading-relaxed">[[TAGLINE]]</p>
    ...
    <section id="the-studio" className="py-24 px-6 md:px-12 bg-surface">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-primary/70 mb-10 leading-relaxed">[[ABOUT_TEXT]]</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input className="bg-background border-none rounded-2xl p-4 focus:ring-2 focus:ring-secondary outline-none" placeholder="[[EMAIL]]" type="email" />
              </div>
            </div>
            <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: <Phone size={20} />, label: "Phone", value: "[[PHONE]]" },
              { icon: <Mail size={20} />, label: "Email", value: "[[EMAIL]]" },
              { icon: <MapPin size={20} />, label: "Studio", value: "[[ADDRESS]]" },
            ].map((item, i) => (
