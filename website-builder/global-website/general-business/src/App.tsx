    ...
    <section className="relative hero-gradient min-h-[90vh] flex items-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 py-20">
        ...
        >
          ...
          <p className="text-white/70 text-lg md:text-xl font-light mb-10 max-w-xl leading-relaxed">[[TAGLINE]]</p>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          ...
          <p className="text-on-surface-variant max-w-2xl text-lg leading-relaxed">
            Engineering-grade solutions for your home and business. Every technician is certified to [[SHOP_NAME]] standards.
          </p>
        </div>
  ...
  return (
    <section className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24">
        <div>
          <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 tracking-tight">[[SHOP_NAME]]: Your Next Project</h2>
          <p className="text-on-surface-variant mb-12 text-lg">[[ABOUT_TEXT]]</p>
    ...
    <footer className="bg-primary text-white pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
        <div className="col-span-1 lg:col-span-1">
          <span className="text-3xl font-black text-white mb-8 block uppercase tracking-tighter">[[SHOP_NAME]]</span>
