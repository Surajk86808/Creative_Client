    ...
    <div className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/85 backdrop-blur-md border-b border-deep-brown/5">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          <div className="text-2xl font-bold uppercase tracking-tighter text-primary font-display flex items-center gap-2">
            ...
            <span>Demitasse Coffee (A Small Step Towards Best Coffee & Community)</span>
          </div>
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl px-6">
          ...
          >
            ...
            Trusted cafe & coffee shop in bengaluru
          </motion.div>
          ...
          >
            Demitasse Coffee (A Small Step Towards Best Coffee & Community)<br/>Trusted cafe & coffee shop in bengaluru
          </motion.h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="font-light text-xl text-muted-brown mb-10 leading-relaxed">
              Demitasse Coffee (A Small Step Towards Best Coffee & Community) provides professional cafe & coffee shop services for customers in Aakruthi Bunglow, 394, 7th Cross Rd, BEML Layout 6th Stage, BEML Layout, Brookefield, Bengaluru, Karnataka 560066. We focus on quality, clear communication, and great results. Call 091672 65681 to get started.
            </div>
      ...
      <section id="locations" className="py-24 bg-white px-6 border-t border-deep-brown/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-muted-brown text-lg mb-10">Trusted cafe & coffee shop in bengaluru</p>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-warm-bg p-6 rounded-xl flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-brown">Aakruthi Bunglow, 394, 7th Cross Rd, BEML Layout 6th Stage, BEML Layout, Brookefield, Bengaluru, Karnataka 560066<br/>bengaluru</p>
                </div>
              </div>
              <div className="bg-warm-bg p-6 rounded-xl flex items-start gap-4">
            ...
            <button className="w-full bg-secondary text-white py-6 rounded-xl flex items-center justify-center gap-4 hover:scale-[1.02] transition-transform shadow-xl active:scale-95">
              ...
              <span className="font-display text-2xl font-bold tracking-widest">CALL: 091672 65681</span>
            </button>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-deep-brown text-white py-16 px-8">
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">Â© 2024 Demitasse Coffee (A Small Step Towards Best Coffee & Community). All Rights Reserved.</p>
