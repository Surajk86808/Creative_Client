        ...
        <div className="flex justify-between items-center px-6 max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-2">
            ...
            <span className="font-headline text-xl font-bold tracking-tighter uppercase">
              <span className="text-primary">Radisson Hotel Bengaluru City Center</span>
        ...
        <section className="bg-surface-container-low py-24 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="w-full md:w-1/2 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">Trusted hotel in bengaluru</p>
          ...
          <div className="max-w-5xl mx-auto glass-card rounded-lg shadow-2xl p-8 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
              <div className="space-y-6">
                ...
                <p className="text-on-surface-variant text-lg">Radisson Hotel Bengaluru City Center provides professional hotel services for customers in 2, Gangadhar Chetty Rd, Halasuru, Yellappa Chetty Layout, Sivanchetti Gardens, Bengaluru, Karnataka 560042. We focus on quality, clear communication, and great results. Call 080 6221 0103 to get started. • 2, Gangadhar Chetty Rd, Halasuru, Yellappa Chetty Layout, Sivanchetti Gardens, Bengaluru, Karnataka 560042</p>
                <div className="space-y-4 pt-4">
                  <div className="flex items-center gap-4">
                    <Phone className="text-coral w-6 h-6" />
                    <span className="font-bold text-primary">080 6221 0103</span>
                  </div>
                  <div className="flex items-center gap-4">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <input className="w-full bg-surface-container-low border-none border-b-2 border-outline-variant focus:border-coral focus:ring-0 rounded-t-lg p-4 font-medium transition-colors" placeholder="" type="email" />
      ...
      <footer className="bg-primary pt-24 pb-12 text-white">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-headline text-2xl font-bold tracking-tighter uppercase">
                  Radisson Hotel Bengaluru City Center <span className="text-coral"></span>
                </span>
              </div>
          ...
          <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-slate-500 text-xs">Â© 2024 Radisson Hotel Bengaluru City Center. All rights reserved.</p>
