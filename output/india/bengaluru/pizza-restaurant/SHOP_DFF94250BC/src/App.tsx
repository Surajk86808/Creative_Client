      ...
      <nav className="fixed top-0 w-full z-50 bg-white/85 backdrop-blur-md border-b border-deep-brown/5">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          <div className="text-2xl font-bold uppercase tracking-tighter text-primary font-display flex items-center gap-2">
            ...
            <span>Chicago Pizza - Whitefield, ITPL, Bangalore | Slice, Smile, Repeat</span>
          </div>
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl px-6">
          ...
          >
            ...
            Trusted pizza restaurant in bengaluru
          </motion.div>
          ...
          >
            Chicago Pizza - Whitefield, ITPL, Bangalore | Slice, Smile, Repeat<br/>Trusted pizza restaurant in bengaluru
          </motion.h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="font-light text-xl text-muted-brown mb-10 leading-relaxed">
              Chicago Pizza - Whitefield, ITPL, Bangalore | Slice, Smile, Repeat provides professional pizza restaurant services for customers in NO.78, ITPL Main Rd, opp. to NEXUS SHANTINIKETAN MALL, next to MANIPAL HOSPITALS, Sadara Mangala Industrial Area, KIADB Export Promotion Industrial Area, Krishnarajapuram, Bengaluru, Karnataka 560048. We focus on quality, clear communication, and great results. Call 089717 51552 to get started.
            </div>
      ...
      <section id="locations" className="py-24 bg-white px-6 border-t border-deep-brown/5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-muted-brown text-lg mb-10">Trusted pizza restaurant in bengaluru</p>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-warm-bg p-6 rounded-xl flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-brown">NO.78, ITPL Main Rd, opp. to NEXUS SHANTINIKETAN MALL, next to MANIPAL HOSPITALS, Sadara Mangala Industrial Area, KIADB Export Promotion Industrial Area, Krishnarajapuram, Bengaluru, Karnataka 560048<br/>bengaluru</p>
                </div>
              </div>
              <div className="bg-warm-bg p-6 rounded-xl flex items-start gap-4">
            ...
            <button className="w-full bg-secondary text-white py-6 rounded-xl flex items-center justify-center gap-4 hover:scale-[1.02] transition-transform shadow-xl active:scale-95">
              ...
              <span className="font-display text-2xl font-bold tracking-widest">CALL: 089717 51552</span>
            </button>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-deep-brown text-white py-16 px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto">
          ...
          <div>
            ...
            <div className="flex">
              <input className="bg-white/10 border-none rounded-l-lg p-3 w-full text-white text-sm focus:ring-1 focus:ring-primary" placeholder="" type="email" />
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">Â© 2024 Chicago Pizza - Whitefield, ITPL, Bangalore | Slice, Smile, Repeat. All Rights Reserved.</p>
