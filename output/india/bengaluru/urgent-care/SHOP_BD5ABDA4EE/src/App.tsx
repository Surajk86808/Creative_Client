  ...
  return (
    <nav className="bg-zinc-950/90 backdrop-blur-md fixed top-0 w-full z-50 flex justify-between items-center px-6 py-4 border-b border-zinc-800/50">
      <div className="flex items-center gap-2">
        ...
        <span className="text-2xl font-headline uppercase tracking-tighter text-primary font-bold">Jai Hanuman Ambulance Service</span>
      </div>
      ...
      <div className="relative z-30 max-w-7xl mx-auto w-full">
        ...
        >
          <div className="space-y-0">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-headline font-bold uppercase tracking-tight text-white leading-none">Jai Hanuman Ambulance Service</h1>
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-headline font-bold uppercase tracking-tight text-primary leading-none">Trusted urgent care in bengaluru</h1>
          </div>
          <p className="text-on-surface-variant font-light text-lg md:text-xl max-w-md leading-relaxed">
            Trusted urgent care in bengaluru
          </p>
    ...
    <section id="about" className="py-24 px-6 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-on-surface-variant mb-12 max-w-md">Jai Hanuman Ambulance Service provides professional urgent care services for customers in 30, 5th Main Rd, opp. ESIC Sub Regional Office, M S K Nagar, DDUTTL, Narasimha Layout, Yeswanthpur, Bengaluru, Karnataka 560022. We focus on quality, clear communication, and great results. Call 097408 02690 to get started.</p>
      ...
      <div className="max-w-xl mx-auto">
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-1">
            ...
            <input 
              className="w-full bg-zinc-950 border-none border-b-2 border-zinc-800 text-on-surface p-4 focus:ring-0 focus:border-primary transition-all placeholder:text-zinc-700 outline-none" 
              placeholder="info@jaihanumanambulance.com" 
              type="email"
            />
          </div>
          <div className="space-y-1">
    ...
    <footer className="bg-zinc-950 border-t border-zinc-900 pt-20 pb-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12">
        <div className="space-y-6">
          <div className="text-2xl font-headline font-bold text-primary uppercase tracking-tighter">Jai Hanuman Ambulance Service</div>
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-xs font-headline tracking-widest text-zinc-500">
            <li className="hover:text-primary hover:translate-x-1 duration-200 transition-all cursor-pointer">30, 5th Main Rd, opp. ESIC Sub Regional Office, M S K Nagar, DDUTTL, Narasimha Layout, Yeswanthpur, Bengaluru, Karnataka 560022</li>
      ...
      <div className="mt-20 border-t border-zinc-900 pt-8 text-center">
        <span className="font-headline uppercase tracking-wider text-[10px] text-zinc-500">
          Â© 2024 Jai Hanuman Ambulance Service. ALL RIGHTS RESERVED.
        </span>
      </div>
    </footer>
  );
